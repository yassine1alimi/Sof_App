...
export class CandidateService {
  ...
  public createCandidate(candidate, fileCV:File, fileLettre:File) {
    ...
    return this.httpClient.post<Candidate>("http://localhost:8087/createcandidate", data);
  }

  public getCandidatesList(){
    console.log('test');
    return this.httpClient.get<any>("http://localhost:8087/candidats");
  }

  public getCandidate(id: number){
    return this.httpClient.get<Candidate>("http://localhost:8087/candidat"+"/"+ id);
  }

  public downloadFile(pathCv:String){
    
    return this.httpClient.get<any>("http://localhost:8087//downloadFile"+"/"+ pathCv);
  }
  ...
  deleteCandidate(id: number) {
    return this.httpClient.delete("http://localhost:8087/candidate/" + id);
